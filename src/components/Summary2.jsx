...
const Summary = () => {
  return (
    <section className="relative py-10 bg-blue-950 h-[800px] flex items-center px-6 md:px-20">
        ...
        <div className="flex-col md:flex-row items-center md:items-start">
          ...
          <div className="flex flex-col items-center md:items-start mt-8 md:mt-0 md:ml-12">
            <h1
              ...
              style={{ fontFamily: "Tahoma, sans-serif", fontSize: "2rem" }}
            >
            ...
            <p
              ...
              style={{ fontFamily: "Tahoma, sans-serif", fontSize: "3rem" }}
            >
              Full Stack Web Developer
            </p>
            <p
              className="text-3xl text-white font-bold"
              style={{ fontFamily: "Verdana, sans-serif", fontSize: "1.25rem" }}
            >
            ...
            <p className="text-xl mt-4 text-white" style={{ fontSize: "1.25rem" }}>
              ...
              possesses a Diploma in Software Engineering. Committed to learning
              and Eager to contribute to dynamic projects, learn from
              experienced professionals, and grow in a collaborative
              environment.
            </p>
          </div>
        </div>
        <div className="flex flex-row h-20 text-blue-400 py-4 px-10">
          <div className="basis-8 text-5xl font-bold" style={{ fontSize: "3rem" }}>05</div>
